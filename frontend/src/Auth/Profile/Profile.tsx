...
const Profile: FC<ProfileProps> = () => {
    ...
    const [rawUrl, setRawUrl] = useState<string | null>(`${process.env.REACT_APP_BACKEND_URL}/${user.img_url}`)
    ...
    const handleUpdate = async (values: any) => {
        try {
            ...
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/auth/${user._id}/updateUser`, FD, { headers });
    ...
    const handleDelete = () => {
        axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/notes/parmanentdeleteallnote_user`, { headers })
            .then((response) => {
            })
            .catch((error) => {
        ...
        axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/auth/${user._id}/deleteUser`, { headers })
            .then((response) => {
                // fetchData()
                setRender(!rander)
                toast.success(response.data.message)
